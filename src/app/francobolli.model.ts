...
export const CountriesByContinent = [
...

  {
    continent: "Европа",
    countries: [
      "Австрия","Акротири","Албания","Андорра","Белоруссия","Бельгия","Болгария","Босния и Герцеговина",
      "Ватикан","Великобритания","Венгрия","Германия","Гернси","Гибралтар","Греция","Дания","Декелия","Джерси",
      "ИрландиямИсландия","Испания","Италия","Кипр","Косово","Латвия","Литва","Лихтенштейн","Люксембург","Македония","Мальта","Молдова",
      "Монако","Нидерланды","Норвегия","Остров Мэн","Польша","Португалия","Румыния","Сан-Марино","Сербия","Словакия","Словения","Украина",
      "Фарерские острова","Финляндия","Франция","Хорватия","Черногория","Чехия","Швейцария","Швеция","Шпицберген","Эстония","Ян-Майен"
    ]
  },
  { continent: "Азия",
    countries: [
  ...
  },
  {
    ...
    countries: [
        "Бермудские Острова", "Гренландия", "Канада", "Мексика", "Остров Клиппертон", "Сен-Пьер и Микелон", "Соединенные Штаты Америки"
    ]
  },
  {
